...
export function CredentialCard({
  ...
  return (
    <>
      <Card
        className="cursor-pointer border-slate-200 bg-white shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md dark:border-slate-800 dark:bg-slate-950"
        onClick={(e) => {
      ...
      >
        ...
        <CardContent className="space-y-3 text-xs">
          ...
          {balanceDisplay && 'loading' in balanceDisplay && balanceDisplay.loading && (
            <div className="flex items-center gap-1 rounded-md bg-muted/50 px-2 py-2 text-muted-foreground">
          ...
          {balanceDisplay && !('loading' in balanceDisplay && balanceDisplay.loading) && 'percentage' in balanceDisplay && (
            <div className="space-y-1.5 rounded-md border bg-slate-50/70 p-2 dark:bg-slate-900/40">
              <div className="flex items-center justify-between gap-3">
              ...
              <Progress value={percentage ?? 0} className="h-2 bg-slate-200 dark:bg-slate-800" />
              ...
              {overageEnabled && (
                <div className="space-y-1 text-[11px]">
                  <div className="flex items-center justify-between gap-3">
                    <span className="font-medium text-purple-600">Overages：Enabled</span>
          ...
          {!balanceDisplay && overageEnabled && (
            <div className="rounded-md border bg-slate-50/70 p-2 dark:bg-slate-900/40">
              <span className="font-medium text-purple-600">Overages：Enabled</span>
          ...
          <div className="space-y-1.5">
            {editingEndpointRegion ? (
              <div className="space-y-2 rounded-md border bg-slate-50/70 p-2 dark:bg-slate-900/40" onClick={(e) => e.stopPropagation()}>
      ...
      <Dialog open={showVerifyDialog} onOpenChange={setShowVerifyDialog}>
        <DialogContent className="sm:max-w-lg">
          ...
          <div className="space-y-4 py-2 text-sm">
            ...
            {verifyBalance && (
              <div className="space-y-2 rounded-md border bg-slate-50/70 p-3 dark:bg-slate-900/40">
